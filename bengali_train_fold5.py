...
if __name__ == '__main__':
    ...
    for i,(train_index, val_index) in enumerate(skf.split(all_imgs,grapheme_labels)):
        ...
        weight_saving_path = '/home/bengalidata/efficientnetb5_cutmix/fold5/'
        resume_checkpoint_path = '/home/bengalidata/efficientnetb5_cutmix/fold5/checkpoint_best_Average_recall.pth'    
        args = { 
                'model':model,
