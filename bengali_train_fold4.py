...
if __name__ == '__main__':
    ...
    for i,(train_index, val_index) in enumerate(skf.split(all_imgs,grapheme_labels)):
        ...
        model = CNN_Model(model_name='efficientnet-b5',global_dim=2048,drp=0.15)
        weight_saving_path = '/home/bengalidata/efficientnetb5_cutmix/fold4/'
        resume_checkpoint_path = '/home/bengalidata/efficientnetb5_cutmix/fold4/checkpoint_best_Average_recall.pth'    
        args = { 
                'model':model,
